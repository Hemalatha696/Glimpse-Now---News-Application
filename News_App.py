...
class NewsApp:
    def __init__(self):
        #fetch data
        self.data = requests.get('https://newsapi.org/v2/everything?q=bitcoin&apiKey=39cd3e03b6254c38a04a962be02f4538').json()
        #initial GUI load
        self.load_gui()
    ...
    def load_news_item(self,index):
        ...
        read = Button(frame,text='Read More',width=15,height=2,command=lambda: self.open_link(self.data['articles'][index]['url']))
        read.pack(side=LEFT)
